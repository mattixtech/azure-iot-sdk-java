...
public abstract class IntegrationTest
{
    ...
    public static boolean runIotHubTests = true;//Boolean.parseBoolean(Tools.retrieveEnvironmentVariableValue("RUN_IOTHUB_TESTS", "true"));
    public static boolean runProvisioningTests = true;//Boolean.parseBoolean(Tools.retrieveEnvironmentVariableValue("RUN_PROVISIONING_TESTS", "true"));

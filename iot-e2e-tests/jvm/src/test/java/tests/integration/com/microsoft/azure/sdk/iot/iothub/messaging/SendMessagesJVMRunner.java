...
package tests.integration.com.microsoft.azure.sdk.iot.iothub.messaging;
...
public class SendMessagesJVMRunner extends SendMessagesTests
{
    public SendMessagesJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint, boolean withProxy) throws Exception
    {

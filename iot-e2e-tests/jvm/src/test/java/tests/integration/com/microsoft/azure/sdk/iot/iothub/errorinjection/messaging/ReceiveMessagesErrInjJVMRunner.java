...
public class ReceiveMessagesErrInjJVMRunner extends ReceiveMessagesErrInjTests
{
    public ReceiveMessagesErrInjJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception
    {

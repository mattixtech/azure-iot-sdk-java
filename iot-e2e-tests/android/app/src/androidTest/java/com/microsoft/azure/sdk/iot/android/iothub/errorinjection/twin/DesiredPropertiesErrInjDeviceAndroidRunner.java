...
public class DesiredPropertiesErrInjDeviceAndroidRunner extends DesiredPropertiesErrInjTests
{
    ...
    public DesiredPropertiesErrInjDeviceAndroidRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
